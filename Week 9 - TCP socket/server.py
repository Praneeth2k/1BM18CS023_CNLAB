...
ip='192.168.56.1' #IP address of the Server, can be used by any PC in LAN to connect to this server
port=5243 #port address
...
while True:
    clientsocket, clientaddr= s.accept()  #Accepting the connection request from a client 
